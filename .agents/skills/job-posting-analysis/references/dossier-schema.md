...
Use these sections in `analysis.html`; combine only when the page remains equally clear.

1. Role and one-sentence problem statement
2. Sources, checked date, and posting status
3. Employer identity and direct/recruiter classification
