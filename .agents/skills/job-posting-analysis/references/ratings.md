...
Score each dimension 0–5 independently. Show one sentence of evidence per score. Do not calculate a single false-precision total.

- Evidence fit: direct, demonstrable relevance today.
- Stretch value: a focused gap that a small project can illuminate.
- Human access: chance of technical judgement before a hard credential screen.
